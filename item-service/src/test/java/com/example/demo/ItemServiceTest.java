...
public class ItemServiceTest extends DatabaseSuite {
  ...
  public void createCustomerTest() {
    CustomerResponse customer = customerService.createCustomer(1l,"Степан", "Иванов");
    assertEquals(customer.customerId(), 1l);
  ...
  public void deleteCustomerTest() {
    CustomerResponse customer = customerService.createCustomer(2l, "Степан", "Иванов");
  ...
  public void increaseBalanceTest() {
    CustomerResponse customer = customerService.createCustomer(3l,"Степан", "Иванов");
  ...
  public void decreaseBalanceTest() {
    CustomerResponse customer = customerService.createCustomer(4l,"Joost", "Klein");
  ...
  public void getBalanceCustomerTest() {
    CustomerResponse customer = customerService.createCustomer(5l, "Marko", "Veisson");
    customerService.increaseBalance(customer.customerId(), 200);
  ...
  public void createProductTest() {
    SellerResponse seller = sellerService.createSeller(6l,"Степан", "Иванов");
  ...
  public void deleteProductTest() {
    SellerResponse seller = sellerService.createSeller(7l, "Kristjan", "Jakobson");
  ...
  public void getProductPriceTest() {
    SellerResponse seller = sellerService.createSeller(8l,"Ramo", "Teder");
  ...
  public void changeCurrentPriceTest() {
    SellerResponse seller = sellerService.createSeller(9l,"Степан", "Иванов");
    ProductResponse product = productService.createProduct("Игрушка", 100, seller.sellerId(), LocalDateTime.of(2024, Month.APRIL, 8, 12, 30), LocalDateTime.of(2024, Month.APRIL, 10, 12, 30), 150, "");
  ...
  public void getSellerByProductTest() {
    SellerResponse seller = sellerService.createSeller(10l,"Степан", "Иванов");
    ProductResponse product = productService.createProduct("Игрушка", 100, seller.sellerId(), LocalDateTime.of(2024, Month.APRIL, 8, 12, 30), LocalDateTime.of(2024, Month.APRIL, 10, 12, 30), 150, "");
  ...
  public void createSellerTest() {
    SellerResponse seller = sellerService.createSeller(11l,"Степан", "Иванов");
  ...
  public void deleteSellerTest() {
    SellerResponse seller = sellerService.createSeller(12l,"Степан", "Иванов");
