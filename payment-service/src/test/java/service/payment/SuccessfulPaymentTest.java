...
class SuccessfulPaymentTest extends DatabaseSuite {
  ...
  public void shouldPaidSucceed() throws JsonProcessingException, InterruptedException {
    Purchase customerPurchase = new Purchase(1L, 1000);
    ...
    records
        ...
        .forEachRemaining(
            record -> {
              ...
              assertEquals(new PaymentProduceMessage(10L, "paid"), message);
            });
    assertEquals(100, ((Purchase)(purchaseRepository.findById(2L).orElseThrow())).getMoney());
  }
}